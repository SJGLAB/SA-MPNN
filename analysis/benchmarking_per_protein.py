...
def main(cfg, args):
    ...
    datasets = {
         ...
         #"P53": ddgBenchDataset(cfg, pdb_dir=os.path.join(misc_data_loc, 'data_all/xtanh_ProStab_main_data-dataset_p53/pdb'),
                                #csv_fname=os.path.join(misc_data_loc, 'data_all/xtanh_ProStab_main_data-dataset_p53/p53.csv')),
         ...
         "S2648": ddgBench(pdb_dir=os.path.join(misc_data_loc, 'data_all/xtanh_ProStab_main_data-dataset_geostab_data/ddG_cleaned/S2648'),
                         csv_fname=os.path.join(misc_data_loc, 'data_all/xtanh_ProStab_main_data-dataset_geostab_data/ddG_cleaned/S2648.csv'),
                         dataset_name='S2648'),
         "S783": ddgBench(pdb_dir=os.path.join(misc_data_loc, 'data_all/xtanh_ProStab_main_data-dataset_geostab_data/ddG_cleaned/S783'),
                        csv_fname=os.path.join(misc_data_loc, 'data_all/xtanh_ProStab_main_data-dataset_geostab_data/ddG_cleaned/S783.csv'),
                        dataset_name='S783'),
         "S461": ddgBench(pdb_dir=os.path.join(misc_data_loc, 'data_all/xtanh_ProStab_main_data-dataset_geostab_data/ddG_cleaned/S461'),
                        csv_fname=os.path.join(misc_data_loc, 'data_all/xtanh_ProStab_main_data-dataset_geostab_data/ddG_cleaned/S461.csv'),
                        dataset_name='S461'),
         "S8754": ddgBench(pdb_dir=os.path.join(misc_data_loc, 'data_all/xtanh_ProStab_main_data-dataset_geostab_data/ddG_cleaned/S8754'),
                         csv_fname=os.path.join(misc_data_loc, 'data_all/xtanh_ProStab_main_data-dataset_geostab_data/ddG_cleaned/S8754.csv'),
                         dataset_name='S8754'),
         "S571": ddgBench(pdb_dir=os.path.join(misc_data_loc, 'data_all/xtanh_ProStab_main_data-dataset_geostab_data/dTm_cleaned/S571'),
                        csv_fname=os.path.join(misc_data_loc, 'data_all/xtanh_ProStab_main_data-dataset_geostab_data/dTm_cleaned/S571.csv'),
                        dataset_name='S571'),
         "S4346": ddgBench(pdb_dir=os.path.join(misc_data_loc, 'data_all/xtanh_ProStab_main_data-dataset_geostab_data/dTm_cleaned/S4346'),
                         csv_fname=os.path.join(misc_data_loc, 'data_all/xtanh_ProStab_main_data-dataset_geostab_data/dTm_cleaned/S4346.csv'),
                         dataset_name='S4346'),
         #"p53": ddgBenchDataset(cfg, pdb_dir=os.path.join(misc_data_loc, 'data_all/xtanh_ProStab_main_data-dataset_p53/pdb'),
                                #csv_fname=os.path.join(misc_data_loc, 'data_all/xtanh_ProStab_main_data-dataset_p53/p53.csv')),
    }
